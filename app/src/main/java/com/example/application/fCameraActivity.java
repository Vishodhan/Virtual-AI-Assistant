...
public abstract class fCameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        camActivity.setOnTouchListener(new View.OnTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(fCameraActivity.this, new GestureDetector.SimpleOnGestureListener() {
                @Override
...
//        }
    ...
    protected void setFragment() {
        ...
        Fragment fragment;
        if (useCamera2API) {
            fCameraConnectionFragment camera2Fragment =
                    fCameraConnectionFragment.newInstance(
                            new fCameraConnectionFragment.ConnectionCallback() {
                                @Override
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    previewHeight = size.getHeight();
                                    previewWidth = size.getWidth();
                                    fCameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
            ...
            fLegacyCameraConnectionFragment frag = new fLegacyCameraConnectionFragment(this,
                    getLayoutId(),
