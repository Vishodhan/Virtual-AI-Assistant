...
package com.example.application.tracking;
...
import com.example.application.tflite.SimilarityClassifier.Recognition;
...
public class fMultiBoxTracker {
  ...
  public fMultiBoxTracker(final Context context) {
